...
class Property
{
    ...
    /**
     * @ORM\Column(type="datetime", options={"default": "1970-01-02 00:00:00"})
     */
    private $updated_at;

    public function __construct()
    {
        $this->createt_at = new \DateTime();
    ...
    public function setCreatetAt(\DateTimeInterface $createt_at): self
    {
